    ...
    return (
      ...
      >
        <div className="flex items-center justify-between w-full min-w-0">
          <span className="font-medium text-xs text-gray-900 truncate flex-1 mr-2">{entry.categoryName}</span>
          <span className="text-xs text-gray-500 flex-shrink-0">{getDuration()}</span>
        </div>
      </div>
    )
  }
      ...
      >
        <div className="flex justify-between items-center h-full">
          ...
          <Button
            ...
            className="rounded-xl opacity-0 group-hover:opacity-100 transition-opacity h-6 w-6 p-0 ml-1 flex-shrink-0"
          >
